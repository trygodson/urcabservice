...
import { JwtAVerify } from '@urcab-workspace/shared';
...
export class JwtAStrategy extends PassportStrategy(Strategy) {
  constructor(
    ...
    super({
      jwtFromRequest: ExtractJwt.fromExtractors([
        (request: any) => {
          return (
            ...
            this.jwtService.sign(JwtAVerify(request?.headers?.authorization.split(' ')[1]).data, {
      ...
      secretOrKey: configService.get('JWT_ASECRET'),
    });
  }
