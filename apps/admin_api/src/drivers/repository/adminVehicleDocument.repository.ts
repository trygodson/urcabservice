...
import { VehicleDocumentRecord, VehicleDocumentRecordDocument } from '@urcab-workspace/shared';

@Injectable()
export class AdminVehicleDocumentRepository extends AbstractRepository<VehicleDocumentRecordDocument> {
